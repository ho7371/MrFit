...
public MemberVO(String id, String password, String name, String phone, String address, String email, GradeVO gradeVO,
		int point, int totalSpent, String status, String answer, String qno, MemberSizeVO msvo) {
	super();
	this.id = id;
...
public MemberSizeVO getMsvo() {
	return msvo;
}

public void setMsvo(MemberSizeVO msvo) {
	this.msvo = msvo;
}
...
public String toString() {
	return "MemberVO [id=" + id + ", password=" + password + ", name=" + name + ", phone=" + phone + ", address="
			+ address + ", email=" + email + ", gradeVO=" + gradeVO + ", point=" + point + ", totalSpent=" + totalSpent
			+ ", status=" + status + ", answer=" + answer + ", qno=" + qno + ", msvo=" + msvo + "]";
}
