		...
		<div class="container"> 
			...
			<div class="col-md-1 account-left"></div>
				...
				<div class="col-md-6 account-left">
					<%-- 새 비밀번호 설정 폼 --%>
					<form action="${pageContext.request.contextPath}/updateAdminPassword.do" method="post" id="PupdateForm">
						...
						<div class="address">
							<span>관리자 Id</span>
							<h4><font color="blue"><strong><sec:authentication property="principal.id"/></strong></font></h4>
						</div>
						<div class="address">
							<span>Password</span>
